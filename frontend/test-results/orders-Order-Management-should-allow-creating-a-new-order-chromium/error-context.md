...
- Name: orders.spec.ts >> Order Management >> should allow creating a new order
- Location: tests\orders.spec.ts:17:7
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::dl22t-1781544501550-b87d5ef0b1af`"
